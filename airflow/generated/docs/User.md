...
**Roles** | Pointer to [**[]UserCollectionItemRolesInner**](UserCollectionItemRolesInner.md) | User roles.  *Changed in version 2.2.0*&amp;#58; Field is no longer read-only.  | [optional] 
